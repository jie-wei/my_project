...
Non-blocking reminder that fires on Write/Edit to source files (.py, .tex)
to remind about running/compiling before marking a task as done.
...
- Files in .claude/, docs/, data/ directories
"""
...
VERIFY_EXTENSIONS = {
    ".py": "run with python3 or pytest",
    ".tex": "compile with xelatex or pdflatex",
}
